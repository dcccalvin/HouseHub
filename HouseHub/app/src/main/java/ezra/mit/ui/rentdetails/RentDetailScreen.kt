package ezra.mit.ui.rentdetails
...
@Composable
fun RentDetailScreen(viewModel: AuthViewModel?, navController: NavHostController) {
...
@Composable
fun RentDetailScreenPreviewLight() {

    RentDetailScreen(null, rememberNavController())
