package ezra.mit.ui.saledetails
...
@Composable
fun SaleDetailScreen(viewModel: AuthViewModel?, navController: NavHostController) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
...
@Composable
fun SaleDetailScreenPreviewLight() {
    SaleDetailScreen(null, rememberNavController())
}